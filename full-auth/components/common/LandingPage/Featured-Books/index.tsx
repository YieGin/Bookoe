  ...
  return (
    <div className='font-Cairo flex lg:justify-start md:justify-center lg:flex-row gap-x-5 pt-10 '>
      <div className='w-full h-full pb-14 sm:px-10 xs:px-3 bg-[#f2f0fe] dark:bg-[#232323] relative overflow-hidden'>
        <DotPattern />
        <div className='absolute top-0 right-2 bg-[#e5e3f3] dark:bg-[#FFE7D4] rounded-full w-[500px] h-[500px] -translate-y-1/2 translate-x-1/2'/>
        <div className='absolute bottom-0 z-0 left-2 bg-[#edebf8] dark:bg-[#FFE7D4] rounded-full w-[300px] h-[300px] translate-y-1/2 -translate-x-1/2'/>
