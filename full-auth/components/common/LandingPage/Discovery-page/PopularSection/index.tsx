...
const PopularSection = () => {
  return (
    <div className='font-Cairo flex lg:justify-start md:justify-center lg:flex-row gap-x-5 pt-10'>
      <div className='w-[100%] h-full mb-10 sm:px-10 xs:px-5 bg-[#e6f1fc] dark:bg-[#11161b] rounded-3xl relative overflow-hidden'>
        <DotPattern />
        <div className='absolute top-0 right-28 dark:right-2 bg-[#d7ebff] dark:bg-[#d9ebfd] rounded-full w-[250px] h-[250px] -translate-y-1/2 translate-x-2/2 dark:translate-x-1/2'/>
        <div className='absolute bottom-0 z-0 left-28 dark:left-2 bg-[#d9ebfd] dark:w-[300px] dark:h-[300px] rounded-full w-[700px] h-[700px] translate-y-1/2 -translate-x-1/2'/>
